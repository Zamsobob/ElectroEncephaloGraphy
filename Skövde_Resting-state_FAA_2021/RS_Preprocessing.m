...
for s = 1:numsubjects
    ...
    EEG=pop_chanedit(EEG, 'load',{[localizer 'Locations_32Channels.ced'], ...
        ...
        'changefield', {33,'labels','Cz'}, 'changefield', {33,'theta','90'}, ...
        'changefield', {33,'radius','0'}, 'changefield', {33,'Z','1'}, ...
        'changefield', {33,'sph_theta','-90'}, 'changefield', {33,'sph_phi','90'}, ...
        'changefield', {33,'sph_radius','1'}, 'changefield', {33,'X','3.7494e-33'}, ...
        'changefield', {33,'Y','-6.1232e-17'}, 'changefield', {1,'theta','43'}, ...
        ...
        'changefield', {3,'radius','0.69444'}, 'changefield', {3,'X','62.0389'}, ...
        ...
        'changefield', {4,'radius','0.5556'}, 'changefield', {4,'X','55.7734'}, ...
        'changefield', {4,'Y','50.2186'}, 'changefield', {4,'Z','-39.9051'}, ...
        'changefield', {4,'sph_theta','42'}, 'changefield', {4,'sph_phi','-28'}, ...
        'changefield', {4,'sph_radius','85'}, 'setref', {'1:33','Cz'}, ...
        'eval','chans = pop_chancenter( chans, [],[]);');

    % RE-REFERENCE TO MASTOIDS AND ADD Cz BACK
    EEG = pop_reref( EEG, [5 6] , 'refloc', struct('labels',{'Cz'}, ...
        'theta', {176.6244}, 'radius', {0.31462}, ...
        'X', {-42.0556}, 'Y', {-2.4806}, 'Z', {27.7464}, ...
        'sph_theta', {-176.6244}, 'sph_phi', {33.3693}, 'sph_radius', {50.4449}, ...
        'type', {''}, 'ref', {'Cz'}, ...
        'urchan', {[]}, ...
        'datachan', {0}, ...
        'sph_theta_besa', {56.6307}, ...
        'sph_phi_besa', {-86.6244}));
