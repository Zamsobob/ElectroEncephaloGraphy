...
EO_FAA <- read_excel(exceldir, 4, col_names = FALSE);
EO_FAA <- as.matrix(EO_FAA)

# SET COLUMN NAMES FOR EASE OF VIEWING
colnames(EO_FAA) <- c("sub-002","sub-005", "sub-006", "sub-008", "sub-009", "sub-011", "sub-013", 
...
exceldir2 <- "D:/FAA_Study_2021/Skovde/Skovde_EEG/EEG_Statistics/FAAscores_CSD.xls"
EC_FAA <- read_excel(exceldir, 5, col_names = FALSE);
EC_FAA <- as.matrix(EC_FAA)

# SET COLUMN NAMES FOR EASE OF VIEWING
colnames(EC_FAA) <- c("sub-002","sub-005", "sub-006", "sub-008", "sub-009", "sub-011", "sub-013", 
                      "sub-014", "sub-015", "sub-019", "sub-020", "sub-021", "sub-022", "sub-025",
                      "sub-027", "sub-028", "sub-029", "sub-030", "sub-031", "sub-032")
View(EC_FAA)
